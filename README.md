...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/everett-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7581&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/everett-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `everett` can be installed with:

```
conda install everett
```

It is possible to list all of the versions of `everett` available on your platform with:
